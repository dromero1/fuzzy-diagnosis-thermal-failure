...
fis = addMF(fis,'ethylene','gauss2mf',[9.34 70 20.957 100],'Name',categories{3});
fis = addMF(fis,'ethylene','gauss2mf',[8.981 120 15.61 150],'Name',categories{4});
fis = addMF(fis,'ethylene','gauss2mf',[21.86 160 0.1 3000],'Name',categories{5});
...
fis = addMF(fis,'ethane','gauss2mf',[11.98 135 0.1 10000],'Name',categories{5});
